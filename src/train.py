...
def parse_arguments():
    ...
    parser.add_argument("--model_save_path", type=str, default="models/trial_model.npy")
    parser.add_argument("--config_save_path", type=str, default="models/trial_config.json")
